  ...
  CREATE TABLE user (
   ...
   INSERT INTO user
   (id, username, password, email, is_admin, firstname, lastname, sex, address, postalcode, city, country)
   VALUES
   (1, 'admin', 'admin', 'admin@BNC-AUSTRIA.tv', 1, 'Admine', 'Adminsdorfer', 'female', 'Admingasse 1/2/3', '8010', 'Graz', 'Austria');
